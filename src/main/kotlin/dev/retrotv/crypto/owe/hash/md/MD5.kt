...
import dev.retrotv.enums.Algorithm.Hash.MD5
import dev.retrotv.utils.encode

/**
 * MD5 알고리즘으로 암호화 하기 위한 [Algorithm.Hash] 추상 클래스의 구현체 입니다.
 *
 * @author  yjj8353
 * @since   1.0.0
 */
class MD5 : HashAlgorithm() {
    override fun hash(data: ByteArray): String {
        return binaryToHex(encode(MD5, data))
    }

    override fun hash(data: ByteArray, encodeFormat: EncodeFormat): String {
        return binaryEncode(encodeFormat, encode(MD5, data))
    }
