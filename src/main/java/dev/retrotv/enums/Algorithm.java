...
public enum Algorithm {
    ...
    , AESCFB128_NO_PADDING("AES/CFB/NoPadding")
    , AESCFB192_NO_PADDING("AES/CFB/NoPadding")
    , AESCFB256_NO_PADDING("AES/CFB/NoPadding")
    , AESOFB128_NO_PADDING("AES/OFB/NoPadding")
    , AESOFB192_NO_PADDING("AES/OFB/NoPadding")
    , AESOFB256_NO_PADDING("AES/OFB/NoPadding")
    , AESCTR128_NO_PADDING("AES/CTR/NoPadding")
    , AESCTR192_NO_PADDING("AES/CTR/NoPadding")
    , AESCTR256_NO_PADDING("AES/CTR/NoPadding")
