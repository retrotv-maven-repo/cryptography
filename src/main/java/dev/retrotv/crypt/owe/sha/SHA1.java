...
/**
 * SHA-1 알고리즘으로 암호화 하기 위한 {@link Checksum}, {@link PasswordWithSalt} 인터페이스의 구현체 입니다.
 *
 * @author  yjj8353
 * @since   1.8
 */
public class SHA1 extends MessageDigestEncrypt implements Checksum, PasswordWithSalt {
