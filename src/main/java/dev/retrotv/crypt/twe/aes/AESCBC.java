...
public abstract class AESCBC implements TwoWayEncryption {
     ...
     */
    @Override
    public byte[] encrypt(@NonNull byte[] data, @NonNull byte[] key, @NonNull byte[] iv) throws CryptFailException {
     ...
     */
    @Override
    public byte[] decrypt(@NonNull byte[] encryptedData, @NonNull byte[] key, @NonNull byte[] iv) throws CryptFailException {
