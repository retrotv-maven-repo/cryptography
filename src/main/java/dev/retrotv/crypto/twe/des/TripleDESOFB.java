...
import static dev.retrotv.enums.CipherAlgorithm.TRIPLE_DESOFB;

public class TripleDESOFB extends DES implements ParameterSpecGenerator<IvParameterSpec> {
    public TripleDESOFB() {
        this.algorithm = TRIPLE_DESOFB;
    }
