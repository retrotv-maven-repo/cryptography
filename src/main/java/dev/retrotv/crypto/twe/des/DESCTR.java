...
import static dev.retrotv.enums.CipherAlgorithm.DESCTR;

public class DESCTR extends DES implements ParameterSpecGenerator<IvParameterSpec> {
    public DESCTR() {
        this.algorithm = DESCTR;
    }
