...
import static dev.retrotv.enums.CipherAlgorithm.DESCTS;

public class DESCTS extends DES implements ParameterSpecGenerator<IvParameterSpec> {
    public DESCTS() {
        this.algorithm = DESCTS;
    }
