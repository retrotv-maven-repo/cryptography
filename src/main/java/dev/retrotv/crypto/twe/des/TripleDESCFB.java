...
import static dev.retrotv.enums.CipherAlgorithm.TRIPLE_DESCFB;

public class TripleDESCFB extends DES implements ParameterSpecGenerator<IvParameterSpec> {
    public TripleDESCFB() {
        this.algorithm = TRIPLE_DESCFB;
    }
